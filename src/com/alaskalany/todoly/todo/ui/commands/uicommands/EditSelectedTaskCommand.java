...
public class EditSelectedTaskCommand extends Command {
    ...
    public EditSelectedTaskCommand(Ui ui) {
    ...
    public void invoke(Integer valueOf) {
        ...
        if (ui.getTaskManager().isTaskIndexValid(valueOf)) {
            System.out
                    .println(SelectEditTaskOption.EDITING_TASK.getValue() + ui.getTaskManager()
