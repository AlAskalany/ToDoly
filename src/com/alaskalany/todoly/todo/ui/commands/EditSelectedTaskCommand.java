...
public class EditSelectedTaskCommand {
    ...
    public enum SelectEditTaskOption {
        EDITING_TASK("Editing Task:"), EDIT_TASK_TITLE("1- Title"), EDIT_TASK_STATUS("2- Status"), EDIT_TASK_PROJECT("3- Project"), EDIT_TASK_DUE_DATE("4- Due date"), ENTER_A_VALID_TASK_NUMBER("Enter a valid task number");
